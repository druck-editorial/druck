...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'pricing-paid-text': 'A hosted reading dashboard, a feed API for RSS, and a Telegram importer. The MIT tracker keeps working without them.',
  ...
  de: {
    ...
    'pricing-paid-text': 'Ein gehostetes Reading-Dashboard, eine Feed-API f&uuml;r RSS und ein Telegram-Importer. Der MIT-Tracker funktioniert auch ohne sie.',
    'chapter-colophon': '07 / COLOPHON',
    'colophon-heading': 'Colophon',
