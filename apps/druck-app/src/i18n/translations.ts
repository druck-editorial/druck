...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'wild-looks-eyebrow': 'Same feed, more skins',
    'wild-looks-title': 'The front page, <em>eight</em> ways.',
    'wild-looks-cta': 'See all 8 looks',
    'sc-close-m': 'Close',
    'sc-eye': 'One feed',
    'sc-intro-h2': 'Eight ways to print the same news.',
    'sc-intro-p': 'The same stories. Scroll, and watch the front page transform.',
    'sc-scroll': 'scroll',
    'sc-outro-big': '8 looks',
    'sc-outro-p': 'Zero bytes of JavaScript.',
  ...
  de: {
    ...
    'wild-looks-eyebrow': 'Gleicher Feed, mehr Looks',
    'wild-looks-title': 'Die Titelseite, <em>acht</em> Varianten.',
    'wild-looks-cta': 'Alle 8 Looks ansehen',
    'sc-close-m': 'Schließen',
    'sc-eye': 'Ein Feed',
    'sc-intro-h2': 'Acht Arten, dieselbe Nachricht zu drucken.',
    'sc-intro-p': 'Dieselben Geschichten. Scroll und sieh, wie sich die Titelseite verwandelt.',
    'sc-scroll': 'scrollen',
    'sc-outro-big': '8 Looks',
    'sc-outro-p': 'Null Byte JavaScript.',
