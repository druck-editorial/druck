...
const SHOWCASE_ENGINE_LOOKS = ['brutalist', 'swiss', 'broadsheet', 'luxury', 'noir', 'bento'];
...
export function renderShowcase(items) {
  ...
  return (
    ...
    '<h2>Nine ways to print the same news.</h2>' +
    '<p>The same stories. Scroll, and watch the front page transform.</p>' +
    '<div class="sc-dn">scroll</div></div></section>' +
    morph +
    '<section class="sc-outro"><div><div class="sc-big">9 looks</div><p>Zero bytes of JavaScript.</p></div></section>'
  );
}
